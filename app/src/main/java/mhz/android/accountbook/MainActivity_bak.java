            ...
            public void onPageSelected(int position) {
                switch (position) {
                    case 0:
                        ...
                        break;
                    case 1:
                        MainActivity_bak.this.setTitle(R.string.activity_title_itemList);
                        break;
                }
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.set_start_day:
                ViewGroup v = new LinearLayout(MainActivity_bak.this);
                ...
                new AlertDialog.Builder(MainActivity_bak.this)
                        ...
                        .setPositiveButton(R.string.actionName_decision, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                DataController.itemList.reloadList();
                                updateDisplayMonthText();
                                Toast.makeText(MainActivity_bak.this, R.string.resultMsg_change, Toast.LENGTH_SHORT).show();
                            }
                        })
                        .show();
                break;
